...
```{r save-preproc-data}
MR_data |> select(-file) |> write_csv("../preproc-data/MR_pav_data.csv")
ST_data |> select(-file) |> write_csv("../preproc-data/ST_pav_data.csv")
MS_data |> select(-file) |> write_csv("../preproc-data/MS_pav_data.csv")
NASATLX_data |> select(-file) |> write_csv("../preproc-data/NASATLX_pav_data.csv")
SEQUENCE_data |> select(-file) |> write_csv("../preproc-data/SEQ_pav_data.csv")
exptime |> select(-file) |> write_csv("../preproc-data/EXPTIME_pav_data.csv")
