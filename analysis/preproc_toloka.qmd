...
```{r}
MR_data_prep |> 
  write_csv("../preproc-data/MR-tol-data.csv")
MS_data_prep |> 
  write_csv("../preproc-data/MS-tol-data.csv")
ST_data_prep |> 
  write_csv("../preproc-data/ST-tol-data.csv")
NASATLX_data_prep |> 
  write_csv("../preproc-data/NASATLX-tol-data.csv")
SEQUENCE_data_prep |> 
  write_csv("../preproc-data/SEQ-tol-data.csv")
WEIGHTS_data_prep |> 
  write_csv("../preproc-data/WEIGHTS-tol-data.csv")
```
