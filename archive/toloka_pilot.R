...
MR_data |> 
  filter(file == "data-toloka/banch2/1907_toloka_2023-07-19_16h56.11.966.csv") |> 
  ggplot(aes(rt, fill = level)) +
  geom_density(alpha = .5) +
  labs(title = "MR", subtitle = "МА1907")
...
NASATLX_data |> 
  ...
  geom_point(position = position_dodge(0.3)) +
  facet_grid(. ~ task) +
  labs(title = "NASA-TLX", subtitle = "МА1907")
...
MR_data |> 
  filter(file == "data-toloka/banch2/toloka_2023-07-19_17h00.04.319.csv") |> 
  ggplot(aes(rt, fill = level)) +
  geom_density(alpha = .5) +
  labs(title = "MR", subtitle = "толкачева")
...
MS_data |> 
  ...
  ggplot(aes(rt, fill = level)) +
  geom_density(alpha = .5) +
  labs(title = "MS", subtitle = "толкачева")
...
ST_data |> 
  ...
  ggplot(aes(rt, fill = level)) +
  geom_density(alpha = .5) +
  labs(title = "ST", subtitle = "толкачева")
...
NASATLX_data |> 
  ...
  geom_point(position = position_dodge(0.3)) +
  facet_grid(. ~ task) +
  labs(title = "NASA-TLX", subtitle = "толкачева")
